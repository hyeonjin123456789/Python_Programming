...
# 3. 문자열은 (순서가 있음)가 있다 -> (Sequence) (인덱싱, 슬라이싱 가능)
...
print(a, b)                          # 원본 문자열은 그대로, 새로운 문자열 객체가 생성됨
print(id(a), id(b))
print(a is b)                          # a와 b는 다른 객체임

print(id(a[0]), id(b[0]))                 # a와 b의 첫 번째 문자는 같은 객체임
